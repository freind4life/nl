...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        const pfp = message.guild.iconURL({ dynamic: true })
        ...
        const embed = new MessageEmbed()
            ...
            .setColor("RANDOM")
            .setThumbnail(pfp)
            .setImage("https://images-ext-1.discordapp.net/external/khF4LKDsfhMoNuhPAD3vLaroSWHK_Jb6COZYatvY9m4/https/media.discordapp.net/attachments/771083397543755776/917670728680226826/IMG_20211008_060208.jpg")
            .addFields(
